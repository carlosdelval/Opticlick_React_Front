    ...
    <div className="my-auto md:max-w-7xl md:mx-auto">
      <div className="flex flex-col md:flex-row w-full justify-between">
        ...
        <div className="overflow-hidden md:w-1/2">
          ...
          <div className="overflow-x-auto bg-white dark:bg-gray-800 border-2 border-black rounded-lg shadow-lg">
            {loading && (
        ...
        {/* Contenedor derecho */}
        <div className="w-1/3 hidden md:flex flex-col space-y-20">
          {/* Contenedor de notificaciones */}
          <div>
            <div className="flex mb-4 space-x-3 justify-end">
              <Lottie
                animationData={calendarAnimation}
                className="h-16"
              />
            ...
            <div className="overflow-x-auto bg-white dark:bg-gray-800 border-2 border-black rounded-lg shadow-lg">
              <div className="flex items-center justify-center w-full h-32 bg-white dark:bg-gray-800">
                <Lottie
                  ...
                  className="my-4"
                />
                <p className="p-4 my-4 text-center font-semibold">
