  ...
  return (
    <div className="relative md:hidden">
      ...
      {isOpen && (
        <div
          ref={dropdownRef}
          className="absolute right-0 z-50 p-3 mt-2 space-y-2 text-sm bg-white border-2 border-black rounded-lg shadow-lg w-72 dark:bg-gray-800 dark:border-gray-700"
        >
          <div className="flex items-center space-x-2">
            ...
            <h4 className="font-bold text-center dark:text-white">
              Notificaciones
            </h4>
          </div>
          <ul className="space-y-2">
            ...
            {notificaciones.map((notif) => (
              <li
                key={notif.id}
                className="flex items-start justify-between p-2 rounded hover:bg-blue-50 dark:hover:bg-gray-700"
              >
          ...
          <div className="flex items-center space-x-2">
            ...
            <h4 className="font-bold text-center dark:text-white">Mensajes</h4>
          </div>
          <ul className="space-y-2">
            {mensajes.length === 0 && (
              <li className="text-gray-500 dark:text-gray-400">
